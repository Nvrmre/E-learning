<header class="bg-white">
  <nav x-data="{ isOpen: false }" class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
    <div class="flex lg:flex-1">
      <a href="#" class="-m-1.5 p-1.5">
        <span class="sr-only">Your Company</span>
        <img class="h-9 w-auto" src="{{ asset('image/tsirt.png') }}" alt="img">
      </a>
    </div>
    ...
    <div class="hidden lg:flex lg:gap-x-12">
        ...
        <div x-show="isOpen"
          ...
          <div class="p-4">
            <div class="group relative flex items-center gap-x-6 rounded-lg p-4 text-sm leading-6 hover:bg-gray-50">
              ...
              <div class="flex-auto">
                <a href="/kelas" class="block font-semibold text-gray-900">
                  Kelas
            ...
            <div class="group relative flex items-center gap-x-6 rounded-lg p-4 text-sm leading-6 hover:bg-gray-50">
              ...
              <div class="flex-auto">
                <a href="/mapel" class="block font-semibold text-gray-900">
                  Mata Pelajaran
                  <span class="absolute inset-0"></span>
                </a>
            ...
            <div class="group relative flex items-center gap-x-6 rounded-lg p-4 text-sm leading-6 hover:bg-gray-50">
              ...
              <div class="flex-auto">
                <a href="/ujian" class="block font-semibold text-gray-900">
                  Ujian
                  <span class="absolute inset-0"></span>
                </a>
            ...
            <div class="flex-auto">
                <a href="/nilai" class="block font-semibold text-gray-900">
                  Nilai
                  <span class="absolute inset-0"></span>
                </a>
      ...
      <a href="/Tugas" class="text-sm font-semibold leading-6 text-gray-900">Tugas</a>
  ...
  <div class="lg:hidden" x-data="{ isOpen: false }" role="dialog" aria-modal="true">
          ...
          <div class="space-y-2 py-6">
            <div class="-mx-3">
              ...
              <div x-show="isOpen"
                ...
                <a href="#" class="block rounded-lg py-2 pl-6 pr-3 text-sm font-semibold leading-7 text-gray-900 hover:bg-gray-50">Kelas</a>
                <a href="#" class="block rounded-lg py-2 pl-6 pr-3 text-sm font-semibold leading-7 text-gray-900 hover:bg-gray-50">Jurusan</a>
                <a href="#" class="block rounded-lg py-2 pl-6 pr-3 text-sm font-semibold leading-7 text-gray-900 hover:bg-gray-50">Mata Pelajaran</a>
                <a href="#" class="block rounded-lg py-2 pl-6 pr-3 text-sm font-semibold leading-7 text-gray-900 hover:bg-gray-50">Ujian</a>
              </div>
            </div>
            <a href="#" class="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50">Leaderboard</a>
            <a href="#" class="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50">Tugas</a>
          </div>
          <div class="py-6">

    ...
    <nav x-data="{ isOpen: false, isLoggedIn: false }" class="bg-white shadow-md">
      <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16">
          ...
          <div class="hidden lg:flex space-x-4">
            <a href="/kelas" class="text-gray-700 hover:text-gray-900 px-3 py-2 rounded-md text-sm font-medium">Kelas</a>
            <a href="/mapel" class="text-gray-700 hover:text-gray-900 px-3 py-2 rounded-md text-sm font-medium">Mata Pelajaran</a>
      ...
      <div x-show="isOpen" @click.away="isOpen = false" class="lg:hidden">
        <div class="px-2 pt-2 pb-3 space-y-1">
          ...
          <a href="/mapel" class="block text-gray-700 hover:bg-gray-100 px-3 py-2 rounded-md text-base font-medium">Mata Pelajaran</a>
